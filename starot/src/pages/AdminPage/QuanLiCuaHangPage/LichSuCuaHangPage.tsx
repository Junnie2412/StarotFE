...
export default function LichSuCuaHangPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Lịch Sử Cửa Hàng - Starot</title>
        <meta name='description' content='Lịch Sử Cửa Hàng' />
        <link rel='canonical' href='https://starotvn.com/admin/quan-li-cua-hang/lich-su-cua-hang' />
      </Helmet>
