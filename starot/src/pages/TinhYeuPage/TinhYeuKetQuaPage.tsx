...
export default function TinhYeuKetQuaPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Kết Quả Tình Yêu - Starot</title>
        <meta name='description' content='Kết quả bói bài về tình yêu' />
        ...
        <main className='flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 lg:pb-36'>
          <div className='w-full max-w-4xl relative'>
            ...
            <button
              ...
              className='absolute bottom-0 right-0 border border-blue rounded flex items-center justify-center w-16 h-8 text-blue hover:border-white hover:text-white hover:bg-blue transition duration-300'
            >
              <FiArrowLeft size={20} />
            </button>
          </div>
