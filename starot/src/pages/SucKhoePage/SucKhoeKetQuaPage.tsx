...
export default function SucKhoeKetQuaPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Kết Quả Sức Khỏe - Starot</title>
        <meta name='description' content='Kết quả bói bài về sức khỏe' />
        <link rel='canonical' href='https://starotvn.com/tram-chua-lanh/suc-khoe' />
      </Helmet>
      <div
